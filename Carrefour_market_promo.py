    ...
    while index < len(magasins):
        try:
            ...
            if found_market:
                ...
                workbook = xlsxwriter.Workbook('Promotions/Carrefour_market/'+magasins_ref[index]+'_'+str(last_index_visited)+'.xlsx')
                ...
                last_index_visited = -1
                index += 1
                print("Tous les markets ont été traités pour ce code postal:",magasins[index])  
        except Exception as e:
            print(e)
            last_index_visited = -1
            index += 1
